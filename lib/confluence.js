 ...
 * @param {Function} callback
 */
Confluence.prototype.getContentLabels = function(id , callback ){
 ...
 * @param {Function} callback
 */
Confluence.prototype.addContentLabels = function(id, labels, callback){
 ...
 * @param {Function} callback
 */
Confluence.prototype.deleteContentLabel = function(id, label, callback){
