 ...
 * @param space
 * @param id
 * @param filepath - absolute path of the file you are sending
 * @param callback
 */
...
/**
 * Allows you to update metadata on the attachments such as comments
 *
 * @param space
 * @param id
 * @param attachmentId
 ...
 * @param callback
 */
Confluence.prototype.updateAttachment = function(space, id, attachmentId, options, callback ){
    ...
    var metadata = {
        ...
        "descendants": {},
        "body": {},
        "metadata": options, // include comment:"This file is cool"
        "restrictions": {}
    }
};
/**
